...
대학생들의 수강과 밀접한 관련이 있는 강의, 조모임 및 개인 일정 관리를 통합하는 서비스와 기타 수강에 도움이 되는 기능을 제공한다.
...
\insertImageNF{usecase_and_externalinterface.pdf}{Usecases \& External Interface Requirements}{usecase}{0.9\textwidth}
\begin{enumerate}
	\item 사용자와 OTL
	...
	OTL 서비스는 Portal SSO 서비스를 이용하여 사용자를 인증하고, 전용 API를 사용하여 개설과목 DB를 얻어온다. (현재 IT개발팀과 구체적인 내용은 협의 중)
