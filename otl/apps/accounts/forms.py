...
class ProfileForm(forms.Form):
    favorite_departments = forms.ModelMultipleChoiceField(queryset=Department.objects.filter(visible = True), required=False, label=u'관심 학과 :', help_text=u'최대 3개까지 선택하실 수 있습니다. (Ctrl키를 누르고 클릭하세요.)')
